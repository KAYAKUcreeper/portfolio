...
// section reached by scrolling reads as "a real page section," not "the
// same popup."
export function SectionPageLayout({ title, children }: SectionPageLayoutProps) {
  return (
    <div className="min-h-screen bg-sao-navy/60 backdrop-blur-sm">
      <div className="mx-auto max-w-3xl px-6 pb-24 pt-20 sm:pt-24">
